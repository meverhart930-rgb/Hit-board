...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (qs.savant === "expected") {
      ...
      // Savant headers: "last_name, first_name",player_id,year,pa,bip,ba,est_ba,...,woba,est_woba,...
      ...
      return { statusCode: 200, headers: { ...CORS, "cache-control": "public, max-age=3600" }, body: JSON.stringify(out) };
    }
